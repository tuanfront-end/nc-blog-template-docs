...
const data = [
  {
    desc: " Awesome product! And the customer service is exceptionally well.",
    name: "Jane Cooper",
    job: "CEO SomeCompany",
    avatar:
  ...
  {
    desc: `I can't express enough, how amazing this service has been for my company.`,
    name: " John Doe",
    job: "Dev SomeCompany",
    avatar:
              ...
              >
                <div className="flex flex-col sm:pr-10 overflow-hidden">
                  <div className="relative pl-12">
                    ...
                    <p className="mt-2 text-sm text-gray-300 sm:text-base lg:text-sm xl:text-base">
                      {item.desc}
                    </p>
                  </div>

                  <h3 className="pl-12 mt-3 text-sm font-medium leading-5 text-gray-200 truncate sm:text-base lg:text-base">
                    {item.name}
                    <span className="mt-1 text-sm leading-5 text-gray-400 truncate">
                      {` - `} {item.job}
                    </span>
                  </h3>
